...
for i in ${!L_values[@]}; do
  ...
  jarvis pkg config adios2_gray_scott_2 L=$L steps=40 out_file=/mnt/${location}/hxu40/ofs-mount/case3/${nprocs}process/out3.bp nprocs=${nprocs} ppn=20 checkpoint_output=/mnt/${location}/hxu40/ofs-mount/case3/ckpt.bp db_path=benchmark_metadata.db
